...
@implementation RNHorizontalBarChartComponentView {
  RNHorizontalBarChartView *_swiftView;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
  if (self = [super initWithFrame:frame]) {
    ...
    _swiftView = [[RNHorizontalBarChartView alloc] initWithFrame:self.bounds];
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
  ...
  const auto &oldP = oldProps
                         ? *std::static_pointer_cast<RNHorizontalBarChartProps const>(oldProps)
